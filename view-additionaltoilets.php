...
$sql = "
    SELECT at.*, s.registration_number 
...
function downloadExcel($data) {
    ...
    echo "ID\tRegistration Number\tSchool Name\tCluster\tCurrent Enrolment\tAdditional Latrines Needed\tLatrine Groups\tNumber of Latrines\tRequests Made\tSummary\n";
...
<head>
    ...
    <title>Water Infrastructure Management System - Additional Toilets Data</title>
...
<body>
    <div class="container">
        ...
        <div class="controls">
            ...
            <a href="Adminlinks.php" class="btn btn-primary">Back</a>
        </div>
                    ...
                    <?php if (!empty($toiletsData)): ?>
                        <?php foreach ($toiletsData as $toilet): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($toilet['cluster']); ?></td>
