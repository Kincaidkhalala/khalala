            ...
            <form action="highschool.php" method="POST" class="space-y-8">
                ...
                <div class="section general-info">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="male_teachers" class="block text-sm font-medium text-gray-700 mb-1">Male Teachers</label>
                        ...
                        <div>
                            <label for="schooltype" class="block text-sm font-medium text-gray-700 mb-1">Cluster</label>
                            <select id="shelter" name="cluster" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <option value="MALIBA-MATSO">MALIBA_MATSO</option>
                                <option value="HOLY TRINITY">HOLY TRINITY</option>
                            </select>
                        </div>
