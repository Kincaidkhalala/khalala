...
function downloadExcel($data) {
    ...
    echo "ID\tRegistration Number\tSchool Name\tCentre\tHas Electricity\tSource\tChallenges\tMitigations\tAdditional Info\n";
                    ...
                    <?php if (!empty($infrastructureData)): ?>
                        <?php foreach ($infrastructureData as $infrastructure): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($infrastructure['centre']); ?></td>
