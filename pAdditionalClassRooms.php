...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert into additionalclassrooms table - using centre column explicitly
...
<body>
    <div class="form-container">
        ...
        <form id="infrastructureForm" action="pAdditionalClassRooms.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="center" name="centre" value="<?php echo htmlspecialchars($centre); ?>" readonly>
            </div>
            ...
            <div id="additionalClassroomsSection" class="conditional-section">
                ...
                <div class="form-group">
                    <label for="requests_made">Where have any requests been made?</label>
