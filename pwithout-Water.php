...
<body class="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-lg p-6 sm:p-8 form-container">
            <form id="infrastructureForm" method="POST" action="pwithout-Water.php">
                ...
                <div class="form-group mb-4">
                    <label for="cluster" class="block text-xl font-medium text-gray-700">Center</label>
                    <input type="text" id="cluster" name="centre" value="<?php echo htmlspecialchars($centre); ?>" readonly
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                </div>
